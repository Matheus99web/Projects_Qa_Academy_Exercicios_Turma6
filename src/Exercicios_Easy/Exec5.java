...
public class Exec5 {
    public int resultadoSoma(int num1, int num2, int num3) {
        return num1 + num2 + num3;
    }

    public int resultadoSubitracao(int num1, int num2, int num3) {
        return num1 - num2 - num3;
    }
    public int resultadoMultiplicacao(int num1, int num2, int num3){
        return num1 * num2 * num3;
    }
    public int resultadoMedia(int num1, int num2, int num3){
